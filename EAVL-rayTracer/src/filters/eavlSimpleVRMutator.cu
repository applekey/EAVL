...
struct TestMyStruct
{
    ...
    EAVL_FUNCTOR tuple<PartialComposite> operator()(PartialComposite ray )
    {
        ...
        return tuple<PartialComposite>(ray);
    }
